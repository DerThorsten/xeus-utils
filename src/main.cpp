...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "xutils " << XEUS_UTILS_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, xutils
    ...
    using interpreter_ptr = std::unique_ptr<xeus_utils::interpreter>;
    interpreter_ptr interpreter = interpreter_ptr(new xeus_utils::interpreter());
